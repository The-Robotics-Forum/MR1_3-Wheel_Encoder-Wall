...
#define echoPin2 20
/*****************************variables**********************************/
float duration1, duration2, pwm1=0, pwm2=0, pwm3=0, cm1, cm2, i=0, j=0, x=0,base=50;
...
void decelerate1()
{
  ...
  pwm1=base*(cm1-dist5)/(dist4-dist5);  //reduce to this pwm value
...
void loop()
{
  ...
  cm1 = constrain(microsecondsToCentimeters(duration1),0,250);
  ...
  cm2 = constrain(microsecondsToCentimeters(duration2),0,250);
 ...
 case '1':*/
  if(abs(cm1-cm2)<=1)
  {
    ...
    {                      
     ...
     else if(cm1<=dist2&&cm1>=dist3)   //stop
     {       
      //pwm1=0;                                        
      //pwm3=0;
      Stop();
  ...
  /*if(x>5)                             //x used to check whether the bot is actually at rest
  {   
      dirFlag=0;
      while(1)
      {
            ...
            if(abs(cm1-cm2)<=1)
          {
            ...
            else if(cm1<=dist6 && cm1>=dist5)         //stop
            {       
              Stop1();
            }
